...
from base.views import CustomLoginView, ResetPasswordView, ChangePasswordView
...
urlpatterns = [
    ...
    path('login/', CustomLoginView.as_view(redirect_authenticated_user=True, template_name='base/login.html',
